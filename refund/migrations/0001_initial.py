    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('queue', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='queue', to='refund.paymentqueue')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.FloatField(default=0)),
                ('state', models.IntegerField(default=0)),
                ('claim_check', models.ImageField(upload_to='')),
                ('queue', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='queue', to='refund.analysisqueue')),
